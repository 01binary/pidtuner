  ...
  return (
    ...
    >
      ...
      <g style={{ pointerEvents: 'none' }}>
        ...
        <text transform="matrix(1 0 0 1 103.9989 8.9245)" fontFamily="'Roboto-Medium', sans-serif, sans-serif" fontSize="12px">0</text>
        <rect x="73.4" y="110" fill="none" width="68" height="12"/>
        <text transform="matrix(1 0 0 1 97.1786 119.0267)" fontFamily="'Roboto-Medium', sans-serif" fontSize="12px">100</text>
        <g id="rightAxis">
          ...
          <text transform="matrix(1 0 0 1 149.6492 105.817)" fontFamily="'Roboto-Medium', sans-serif" fontSize="12px">-75</text>
          <rect x="140" y="7.7" fill="none" width="36.9" height="12"/>
          <text transform="matrix(1 0 0 1 149.6492 16.6725)" fontFamily="'Roboto-Medium', sans-serif" fontSize="12px">-25</text>
          <rect x="170.9" y="7.7" fill="none" width="49" height="12"/>
          <text transform="matrix(1 0 0 1 177.2629 16.6725)" fill="#5B5B5B" fontFamily="'Roboto-Medium', sans-serif" fontSize="12px">RPWM</text>
          <rect x="160.3" y="53" fill="none" width="36.9" height="12"/>
          <text transform="matrix(1 0 0 1 169.9804 62.0267)" fontFamily="'Roboto-Medium', sans-serif" fontSize="12px">-50</text>
        </g>
        <g id="leftAxis">
          ...
          <text transform="matrix(1 0 0 1 49.5592 16.6725)" fontFamily="'Roboto-Medium', sans-serif" fontSize="12px">25</text>
          <rect x="17.6" y="53" fill="none" width="36.9" height="12"/>
          <text transform="matrix(1 0 0 1 29.2288 62.0267)" fontFamily="'Roboto-Medium', sans-serif" fontSize="12px">50</text>
          <rect x="37.9" y="96.8" fill="none" width="36.9" height="12"/>
          <text transform="matrix(1 0 0 1 49.5592 105.817)" fontFamily="'Roboto-Medium', sans-serif" fontSize="12px">75</text>
          <rect y="7.7" fill="none" width="45.5" height="12"/>
          <text transform="matrix(1 0 0 1 5.1185 16.6725)" fill="#5B5B5B" fontFamily="'Roboto-Medium', sans-serif" fontSize="12px">LPWM</text>
        </g>
        <g id="rightGrad">
