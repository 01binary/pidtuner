...
export const VelocityKnob = () => {
  ...
  return (
    ...
    >
      <line
        stroke="red"
        x1={knobCenterX - originX}
        y1={knobCenterY - originY}
        x2={debugX}
        y2={debugY}
      />
      <path
        ...
        c1.6-5.3-2-11.8-7.4-13c-3.8-0.9-7-2.7-9.6-5.7c-1.4-1.6-3.1-2.4-5.2-2.5C109,30.5,108.2,30.5,107.4,30.5 M107.4,32.6
        c0.7,0,1.3,0.6,1.3,1.3s-0.6,1.3-1.3,1.3c-0.7,0-1.3-0.6-1.3-1.3S106.7,32.6,107.4,32.6z M127.1,57.4c0,10.8-8.8,19.6-19.6,19.6
        c-10.8,0-19.6-8.9-19.6-19.6c0-10.8,8.8-19.6,19.6-19.6c10.8,0,19.6,8.8,19.6,19.6C127.1,57.3,127.1,57.4,127.1,57.4
        C127.1,57.4,127.1,57.4,127.1,57.4z"
      />
      <rect x="73.4" y="-0.1" fill="none" width="68" height="12"/>
      <text transform="matrix(1 0 0 1 103.9989 8.9245)" fontFamily="'Roboto-Medium'" fontSize="12px">0</text>
      <rect x="73.4" y="110" fill="none" width="68" height="12"/>
      <text transform="matrix(1 0 0 1 97.1786 119.0267)" fontFamily="'Roboto-Medium'" fontSize="12px">100</text>
      <g id="rightAxis">
        ...
        <text transform="matrix(1 0 0 1 149.6492 105.817)" fontFamily="'Roboto-Medium'" fontSize="12px">-75</text>
        <rect x="140" y="7.7" fill="none" width="36.9" height="12"/>
        <text transform="matrix(1 0 0 1 149.6492 16.6725)" fontFamily="'Roboto-Medium'" fontSize="12px">-25</text>
        <rect x="170.9" y="7.7" fill="none" width="49" height="12"/>
        <text transform="matrix(1 0 0 1 177.2629 16.6725)" fill="#5B5B5B" fontFamily="'Roboto-Medium'" fontSize="12px">RPWM</text>
        <rect x="160.3" y="53" fill="none" width="36.9" height="12"/>
        <text transform="matrix(1 0 0 1 169.9804 62.0267)" fontFamily="'Roboto-Medium'" fontSize="12px">-50</text>
      </g>
      <g id="leftAxis">
        ...
        <text transform="matrix(1 0 0 1 49.5592 16.6725)" fontFamily="'Roboto-Medium'" fontSize="12px">25</text>
        <rect x="17.6" y="53" fill="none" width="36.9" height="12"/>
        <text transform="matrix(1 0 0 1 29.2288 62.0267)" fontFamily="'Roboto-Medium'" fontSize="12px">50</text>
        <rect x="37.9" y="96.8" fill="none" width="36.9" height="12"/>
        <text transform="matrix(1 0 0 1 49.5592 105.817)" fontFamily="'Roboto-Medium'" fontSize="12px">75</text>
        <rect y="7.7" fill="none" width="45.5" height="12"/>
        <text transform="matrix(1 0 0 1 5.1185 16.6725)" fill="#5B5B5B" fontFamily="'Roboto-Medium'" fontSize="12px">LPWM</text>
      </g>
      <g id="rightGrad">
