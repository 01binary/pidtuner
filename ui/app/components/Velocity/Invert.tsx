  ...
  <div className={styles.invert}>
    <button onClick={onClick}>
      <svg
        ...
        viewBox="0 0 98.4 48"
      >
        <circle fill="none" stroke="#A5A5A5" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="37.9" cy="33" r="6.7"/>
        ...
        <circle fill="none" stroke="#A5A5A5" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" cx="60.5" cy="15" r="6.7"/>
